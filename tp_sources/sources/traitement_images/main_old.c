...
#define MIRROIR_HORIZONTAL	0
#define MIRROIR_VERTICAL	1	
...
//------------------------------------------------------------------------
void Mirroir(unsigned char* image, int largeur, int hauteur, char type) 
//------------------------------------------------------------------------
{
...
int main(int argc, char* argv[]) 
//---------------------------------------------------------------------------
// ouvre une image, lui applique un effet mirroir
{
	unsigned char* image ;
	int largeur ;
	int hauteur ;
	...
	image = LireImagePGM("guadalest.pgm" , &largeur, &hauteur) ;
	Mirroir(image, largeur, hauteur, MIRROIR_VERTICAL) ;
	EcrireImagePGM("mirroir.pgm", image, largeur, hauteur) ;
	AfficherImage("mirroir.pgm") ;
